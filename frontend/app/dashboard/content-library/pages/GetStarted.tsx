    ...
    <div className="space-y-2 sm:space-y-4 px-4 sm:px-8 md:px-12 bg-white backdrop-blur-sm rounded-2xl p-8 w-full max-w-7xl mx-auto pr-4 sm:pr-6">
      <section className="text-center w-full">
        ...
        <p className="text-sm sm:text-lg text-slate-600 max-w-3xl mx-auto w-full">
          Your centralized hub for managing, organizing, and accessing all your
          digital content
        </p>
      </section>

      <section className="bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-xl shadow-sm p-2 sm:p-8 w-full">
        <h2 className="text-lg sm:text-2xl font-semibold text-slate-800 mb-2 sm:mb-4">
          What is Content Library?
        </h2>
        <p className="text-sm sm:text-lg text-slate-600">
          Content Library is your intelligent content management system that
          helps you organize, store, and retrieve your digital assets
          efficiently. With AI-powered categorization and smart search features,
          finding and managing your content has never been easier.
        </p>
      </section>

      <section className="bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-xl shadow-sm p-2 sm:p-8 w-full">
        <h2 className="text-lg sm:text-2xl font-semibold text-slate-800 mb-2 sm:mb-6">
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <div className="flex justify-between items-start">
                <h3 className="text-sm sm:text-lg font-medium text-slate-800 pr-2 sm:pr-4">
                  {faq.question}
                </h3>
                <svg
                  className={`w-4 h-4 sm:w-6 sm:h-6 transform transition-transform flex-shrink-0 ${
              ...
              {expandedFaq === index && (
                <p className="text-xs sm:text-base text-slate-600 mt-1 sm:mt-3">
                  {faq.answer}
                </p>
              )}
            </div>
