...
import { YouTubePost, YouTubePrivacy } from '../types';
    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500">Maximum 500 characters total</p>
            </div>
            ...
            <div>
                ...
                <select
                    ...
                    onChange={(e) => onInputChange('privacyStatus', e.target.value as YouTubePrivacy)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                >
            ...
            {/* Generate Content Button - Moved to bottom */}
